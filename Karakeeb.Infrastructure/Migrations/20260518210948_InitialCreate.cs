    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScrapCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScrapItems_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ScrapItems_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScrapItems_ScrapCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Offers_ScrapItems_ScrapItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScrapImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScrapImages_ScrapItems_ScrapItemId",
                        column: x => x.ScrapItemId,
                        principalTable: "ScrapItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Deals_ScrapItems_ScrapItemId",
                        column: x => x.ScrapItemId,
                        principalTable: "ScrapItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_ScrapItemId",
                table: "Offers",
                column: "ScrapItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ScrapImages_ScrapItemId",
                table: "ScrapImages",
                column: "ScrapItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ScrapItems_ApplicationUserId",
                table: "ScrapItems",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ScrapItems_CategoryId",
                table: "ScrapItems",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ScrapItems_SellerId",
                table: "ScrapItems",
                column: "SellerId");
        }
